...
DATE            = '06262026'    # Acquisition date, format MMDDYYYY
FILE_NUM        = 5             # TSeries number (e.g. 3 → matches folder ending in -003)
STIM_FILE       = 5             # PsychoPy file, Set to -1 if there is no stimulus file.
